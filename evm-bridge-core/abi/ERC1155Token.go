...
func bindERC1155Token(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ERC1155TokenABI))
	if err != nil {
		return nil, err
	}
...
func (_ERC1155Token *ERC1155TokenTransactor) Mint(opts *bind.TransactOpts, account common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _ERC1155Token.contract.Transact(opts, "mint", account, id, amount, data)
}
...
func (_ERC1155Token *ERC1155TokenSession) Mint(account common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _ERC1155Token.Contract.Mint(&_ERC1155Token.TransactOpts, account, id, amount, data)
}
...
func (_ERC1155Token *ERC1155TokenTransactor) SetURI(opts *bind.TransactOpts, newuri string) (*types.Transaction, error) {
	return _ERC1155Token.contract.Transact(opts, "setURI", newuri)
}
...
func (_ERC1155Token *ERC1155TokenSession) SetURI(newuri string) (*types.Transaction, error) {
	return _ERC1155Token.Contract.SetURI(&_ERC1155Token.TransactOpts, newuri)
}
